...
(function() {
  ...
  (d = function(a, b) {
    ...
    for (c in b.prototype)
      try {
        (e = b.prototype[c]), null == a[c] && 'function' != typeof e
          ? d.push((a[c] = e))
          : d.push(void 0);
      } catch (f) {
        f;
    ...
    checks: {
      xhr: {
        url: function() {
          return '/static/favicons/favicon.ico?_=' + new Date().getTime();
        },
        timeout: 5e3,
        type: 'HEAD',
      },
    ...
    if (null != f[a]) {
      if (b) {
        for (d = 0, g = []; d < f[a].length; )
          (e = f[a][d]), e[0], (c = e[1]), c === b ? g.push(f[a].splice(d, 1)) : g.push(d++);
        return g;
      }
      return (f[a] = []);
    }
    ...
    return (h = function() {
      ...
      : (
          ...
          (a.onreadystatechange = function() {
            return 4 === a.readyState ? h() : 0 === a.readyState && c(), 'function' == typeof f
    ...
    var c;
    (c = new XMLHttpRequest()), (c.offline = !1), c.open(
      a.getOption('checks.xhr.type'),
      a.getOption('checks.xhr.url'),
      !0
    ), null != c.timeout && (c.timeout = a.getOption('checks.xhr.timeout')), b(
      c,
      a.markUp,
      a.markDown
    );
    ...
    var b;
    (b = document.createElement('img')), (b.onerror = a.markDown), (b.onload =
      a.markUp), (b.src = a.getOption('checks.image.url'));
    ...
    if (
      (
        ...
        (window.XMLHttpRequest = function(a) {
          var b, d, f;
          return (f = new c(a)), e(f, a), (d =
            f.setRequestHeader), (f.headers = {}), (f.setRequestHeader = function(a, b) {
      ...
      return (b = window.XDomainRequest), (window.XDomainRequest = function() {
        var a;
  ...
  (d = Offline.reconnect = {}), (f = null), (e = function() {
    ...
    return null != d.state &&
      'inactive' !== d.state &&
      Offline.trigger('reconnect:stopped'), (d.state = 'inactive'), (d.remaining = d.delay =
    ...
    return (a =
      null != (b = Offline.getOption('reconnect.delay'))
        ? b
        : Math.min(Math.ceil(1.5 * d.delay), 3600)), (d.remaining = d.delay = a);
  }), (g = function() {
    if ('connecting' !== d.state)
      return (d.remaining -= 1), Offline.trigger('reconnect:tick'), 0 === d.remaining
        ? h()
        : void 0;
  }), (h = function() {
    if ('waiting' === d.state)
      return Offline.trigger('reconnect:connecting'), (d.state = 'connecting'), Offline.check();
  }), (a = function() {
    if (Offline.getOption('reconnect'))
      return e(), (d.state = 'waiting'), Offline.trigger('reconnect:started'), (f = setInterval(
        g,
        1e3
      ));
  }), (i = function() {
    ...
    if (Offline.getOption('reconnect'))
      return 'connecting' === d.state
        ...
        : void 0;
  }), (d.tryNow = h), e(), Offline.on('down', a), Offline.on('confirmed-down', c), Offline.on(
    'up',
    i
  );
}.call(this), function() {
  ...
  (c = []), (f = !1), (d = function(a) {
    ...
    var b, d, f, g, h, i, j;
    if (!1 !== Offline.getOption('requests')) {
      for (Offline.trigger('requests:flush'), i = {}, d = 0, g = c.length; d < g; d++)
          ...
          return null === g.onprogress
            ...
            : (
                ...
                (g.onreadystatechange = function() {
                  return 0 === g.readyState
                    ? f()
                    : 4 === g.readyState &&
                      (0 === g.status || g.status >= 12e3) &&
                      f(), 'function' == typeof b ? b.apply(null, arguments) : void 0;
                })
              );
  ...
  (b = '<div class="offline-ui"><div class="offline-ui-content"></div></div>'), (a =
    '<a href class="offline-ui-retry"></a>'), (f = function(a) {
    var b;
    ...
    var c, h;
    return (g = f(b)), document.body.appendChild(g), null != Offline.reconnect &&
      ...
      ), d('offline-ui-' + Offline.state), (e = g.querySelector('.offline-ui-content'));
  }), (j = function() {
    return l(), Offline.on('up', function() {
      return k(
        'offline-ui-down'
      ), d('offline-ui-up'), h('offline-ui-up-2s', 2), h('offline-ui-up-5s', 5);
    }), Offline.on('down', function() {
      return k(
        'offline-ui-up'
      ), d('offline-ui-down'), h('offline-ui-down-2s', 2), h('offline-ui-down-5s', 5);
      ...
      return d(
        'offline-ui-waiting'
      ), k('offline-ui-connecting'), (a = m(Offline.reconnect.remaining)), (b = a[0]), (c = a[1]), e.setAttribute('data-retry-in-value', b), e.setAttribute('data-retry-in-unit', c);
    }), Offline.on('reconnect:stopped', function() {
      return k(
        'offline-ui-connecting offline-ui-waiting'
      ), e.setAttribute('data-retry-in-value', null), e.setAttribute('data-retry-in-unit', null);
    ...
    : null != document.addEventListener
      ...
      : (
          ...
          (document.onreadystatechange = function() {
            return 'complete' === document.readyState && j(), 'function' == typeof c
